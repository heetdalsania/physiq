...
export function OnboardScreen(props) {
  const onboardStep = props.onboardStep, setOnboardStep = props.setOnboardStep;
  const obName = props.obName, setObName = props.setObName;
  const obAge = props.obAge, setObAge = props.setObAge;
  const obWeight = props.obWeight, setObWeight = props.setObWeight;
  const obHeight = props.obHeight, setObHeight = props.setObHeight;
  const obSex = props.obSex, setObSex = props.setObSex;
  const obBodyfat = props.obBodyfat, setObBodyfat = props.setObBodyfat;
  const obGoal = props.obGoal, setObGoal = props.setObGoal;
  const obActivity = props.obActivity, setObActivity = props.setObActivity;
  const obSteps = props.obSteps, setObSteps = props.setObSteps;
  const obGymDays = props.obGymDays, setObGymDays = props.setObGymDays;
  const finishOnboard = props.finishOnboard;
